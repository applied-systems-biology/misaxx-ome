...
ome::xml::model::enums::PixelType misaxx_ome::opencv_depth_to_ome_pixel_type(int opencv_depth) {
    switch (opencv_depth) {
        case CV_8U:
...
misaxx_ome::opencv_to_ome_series_metadata(const cv::Mat &opencv_image, ome::files::dimension_size_type num_images) {
...
misaxx_ome::opencv_to_ome_metadata(const cv::Mat &opencv_image, ome::files::dimension_size_type num_images,
...
void misaxx_ome::opencv_to_ome(const cv::Mat &opencv_image, ome::files::out::OMETIFFWriter &ome_writer,
