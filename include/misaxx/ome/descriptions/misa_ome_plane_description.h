...
namespace misaxx::ome {
     ...
     */
    struct misa_ome_plane_description : public misaxx::misa_data_description, private boost::equality_comparable<misa_ome_plane_description, boost::partially_ordered<misa_ome_plane_description>> {
...
namespace std {
    template <> struct hash<misaxx::ome::misa_ome_plane_description>
    {
